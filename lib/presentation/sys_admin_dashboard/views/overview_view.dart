...
// ─────────────────────────────────────────────────────────────────────────────
// OVERVIEW VIEW — Logic unchanged, premium UI applied
// ─────────────────────────────────────────────────────────────────────────────
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      return ListTile(
                        ...
                        leading: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isWarning ? AppColors.warningLight : AppColors.primaryLight,
                            shape: BoxShape.circle,
                          ),
                          child: Icon(
                            isWarning ? Icons.priority_high_rounded : Icons.info_outline_rounded,
                            size: 18,
                        ...
                        subtitle: entityId.isNotEmpty
                            ? Text('Entity: $entityId', style: AppTextStyles.bodySm)
                            : null,
                        trailing: Text(
                          timeLabel,
