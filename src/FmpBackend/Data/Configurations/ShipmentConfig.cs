...
public class ShipmentConfiguration : IEntityTypeConfiguration<Shipment>
{
    public void Configure(EntityTypeBuilder<Shipment> entity)
    {
        ...
        entity.Property(e => e.SenderOrganizationId)
              .HasColumnName("sender_organization_id");

        entity.Property(e => e.ReceiverOrganizationId)
              .HasColumnName("receiver_organization_id");

        entity.Property(e => e.CreatedByUserId)
              .HasColumnName("created_by_user_id");

        entity.Property(e => e.PickupAddressId)
              .HasColumnName("pickup_address_id");

        entity.Property(e => e.DropAddressId)
        ...
        entity.Property(e => e.CargoVolumeCubicMeters)
        ...
        entity.Property(e => e.UnloadingCharges)
        ...
        entity.Property(e => e.TotalEstimatedPrice)
