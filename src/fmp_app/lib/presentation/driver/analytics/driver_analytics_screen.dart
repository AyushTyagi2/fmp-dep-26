...
class _DriverAnalyticsScreenState extends State<DriverAnalyticsScreen> {
  ...
  Future<void> _fetchData() async {
    try {
      ...
      final data = await source.getDriverAnalytics();
      if (mounted) {
        setState(() {
          _data = data;
          _isLoading = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Earnings & Performance')),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            AppLineChart(title: 'Daily Earnings (Last 7 Days)', data: _data!.dailyEarnings),
          ],
        ),
      ),
    );
